    ...
    <div className="bg-gray-100 dark:bg-darkBg">
      ...
      <main className="mx-auto max-w-7xl sm:px-6 lg:px-8 ">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 pt-6 lg:grid-cols-4">
          {/* Filters */}
          <form className="sticky top-20 hidden h-[600px] rounded-md bg-white p-3 shadow lg:block">
          ...
          <div className="col-span-1 lg:col-span-3">
            <div className="mx-3 mx-auto grid grid-cols-1 justify-items-center gap-y-7 gap-x-8 sm:grid-cols-2 md:grid-cols-3 lg:mx-0 lg:max-w-none ">
              <ProjectCard />
              <ProjectCard />
              <ProjectCard />
              <ProjectCard />
