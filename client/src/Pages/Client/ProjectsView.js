...
export default function ProjectsView() {
  ...
  return (
    <div className="bg-gray-100 dark:bg-darkBg">
      ...
      <div className="grid grid-cols-1 px-8 pt-6 mx-auto grid-auto-flow max-w-7xl gap-y-5 gap-x-8 overflow-clip sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {/* <Filter /> */}
        <form className="sticky z-20 hidden w-64 row-span-2 p-3 bg-white rounded-md shadow top-20 lg:block">
