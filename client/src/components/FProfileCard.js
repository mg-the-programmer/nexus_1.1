    ...
    <article
      ...
      <div className="relative flex items-center w-full gap-x-4">
        <div className="inline-block hs-tooltip">
          <a className="relative hs-tooltip-toggle " href="#">
            <img
            ...
            <div
              className="absolute z-10 invisible inline-block px-2 py-1 text-xs font-medium text-white transition-opacity bg-gray-900 rounded-md shadow-sm opacity-0 hs-tooltip-content hs-tooltip-shown:visible hs-tooltip-shown:opacity-100 dark:bg-slate-700"
              role="tooltip">
      ...
      <div className="flex flex-wrap items-center text-xs skils gap-y-2 gap-x-3">
      ...
      <div className="flex flex-wrap w-full mt-1 pricing justify-evenly gap-y-2">
        <p className="font-medium text-gray-900 text-md">
          <span className="text-gray-900 text-bold"> ${post.rate}</span>
          <span className="text-gray-600">/hr</span>
        </p>
        <p className="font-medium text-md">
          <span className="text-gray-900 text-bold"> ${post.price}+</span>
          <span className="text-gray-600"> earned</span>
        </p>
        <p className="font-medium text-md">
          <span className="text-gray-900 text-bold"> {post.jobSuccess}%</span>
      ...
      <div className="title&description group flex flex-col gap-y-2 border-b pb-3">
        ...
        <p className="text-sm leading-6 line-clamp-3 ">{post.description}</p>
      ...
      <div className="flex justify-end w-full px-2 callForAction gap-x-4 ">
